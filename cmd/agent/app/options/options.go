...
type GrpcProxyAgentOptions struct {
	...
	ProxyServerPort int
	AlpnProtos      []string
	// Enables negotiated DATA flow control between the agent and proxy servers.
...
func (o *GrpcProxyAgentOptions) ClientSetConfig(dialOptions ...grpc.DialOption) *agent.ClientSetConfig {
	return &agent.ClientSetConfig{
		...
		EnableAgentServerDataFlowControl: o.EnableAgentServerDataFlowControl,
	}
}
...
func (o *GrpcProxyAgentOptions) Flags() *pflag.FlagSet {
	...
	flags.BoolVar(&o.EnableAgentServerDataFlowControl, "enable-agent-server-data-flow-control", o.EnableAgentServerDataFlowControl, "Enable negotiated flow control for DATA exchanged between the agent and proxy servers. Currently applies only to agent-to-server DATA; server-to-agent DATA remains legacy.")
...
func (o *GrpcProxyAgentOptions) Print() {
	...
	klog.V(1).Infof("EnableAgentServerDataFlowControl set to %v.\n", o.EnableAgentServerDataFlowControl)
