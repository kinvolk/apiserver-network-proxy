...
const (
	...
	PacketType_WINDOW_UPDATE PacketType = 7
)
...
type FlowControlFeature int32

const (
	FlowControlFeature_FLOW_CONTROL_FEATURE_UNSPECIFIED FlowControlFeature = 0
	FlowControlFeature_AGENT_TO_SERVER_BYTE_WINDOW_V1   FlowControlFeature = 1
)

// Enum value maps for FlowControlFeature.
var (
	FlowControlFeature_name = map[int32]string{
		0: "FLOW_CONTROL_FEATURE_UNSPECIFIED",
		1: "AGENT_TO_SERVER_BYTE_WINDOW_V1",
	}
	FlowControlFeature_value = map[string]int32{
		"FLOW_CONTROL_FEATURE_UNSPECIFIED": 0,
		"AGENT_TO_SERVER_BYTE_WINDOW_V1":   1,
	}
)

func (x FlowControlFeature) Enum() *FlowControlFeature {
	p := new(FlowControlFeature)
	*p = x
	return p
}

func (x FlowControlFeature) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (FlowControlFeature) Descriptor() protoreflect.EnumDescriptor {
	return file_konnectivity_client_proto_client_client_proto_enumTypes[1].Descriptor()
}

func (FlowControlFeature) Type() protoreflect.EnumType {
	return &file_konnectivity_client_proto_client_client_proto_enumTypes[1]
}

func (x FlowControlFeature) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use FlowControlFeature.Descriptor instead.
func (FlowControlFeature) EnumDescriptor() ([]byte, []int) {
...
func (x *Packet) GetWindowUpdate() *WindowUpdate {
	if x, ok := x.GetPayload().(*Packet_WindowUpdate); ok {
...
type Packet_WindowUpdate struct {
	WindowUpdate *WindowUpdate `protobuf:"bytes,9,opt,name=window_update,json=windowUpdate,proto3,oneof"`
}
...
func (*Packet_WindowUpdate) isPacket_Payload() {}
...
type DialRequest struct {
	...
	OfferedFlowControlFeatures []FlowControlFeature `protobuf:"varint,4,rep,packed,name=offered_flow_control_features,json=offeredFlowControlFeatures,proto3,enum=FlowControlFeature" json:"offered_flow_control_features,omitempty"`
}
...
func (x *DialRequest) GetOfferedFlowControlFeatures() []FlowControlFeature {
	if x != nil {
		return x.OfferedFlowControlFeatures
	}
	return nil
}
...
type DialResponse struct {
	...
	Random                      int64                `protobuf:"varint,3,opt,name=random,proto3" json:"random,omitempty"`
	AcceptedFlowControlFeatures []FlowControlFeature `protobuf:"varint,4,rep,packed,name=accepted_flow_control_features,json=acceptedFlowControlFeatures,proto3,enum=FlowControlFeature" json:"accepted_flow_control_features,omitempty"`
}
...
func (x *DialResponse) GetAcceptedFlowControlFeatures() []FlowControlFeature {
	if x != nil {
		return x.AcceptedFlowControlFeatures
	}
	return nil
}
...
type WindowUpdate struct {
	...
	ConnectId     int64  `protobuf:"varint,1,opt,name=connect_id,json=connectId,proto3" json:"connect_id,omitempty"`
	MaxDataOffset uint64 `protobuf:"varint,2,opt,name=max_data_offset,json=maxDataOffset,proto3" json:"max_data_offset,omitempty"`
}
...
func (x *WindowUpdate) GetConnectId() int64 {
	if x != nil {
		return x.ConnectId
	}
	return 0
...
func (x *WindowUpdate) GetMaxDataOffset() uint64 {
	if x != nil {
		return x.MaxDataOffset
	}
	return 0
}
...
var file_konnectivity_client_proto_client_client_proto_rawDesc = []byte{
	...
	0xa7, 0x03, 0x0a, 0x06, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x1f, 0x0a, 0x04, 0x74, 0x79,
	...
	0x00, 0x52, 0x05, 0x64, 0x72, 0x61, 0x69, 0x6e, 0x12, 0x34, 0x0a, 0x0d, 0x77, 0x69, 0x6e, 0x64,
	0x6f, 0x77, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x0d, 0x2e, 0x57, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x48, 0x00,
	0x52, 0x0c, 0x77, 0x69, 0x6e, 0x64, 0x6f, 0x77, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x09,
	0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0xb3, 0x01, 0x0a, 0x0b, 0x44, 0x69,
	0x61, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x6f,
	...
	,
	...
	,
...
var file_konnectivity_client_proto_client_client_proto_goTypes = []interface{}{
	...
	(FlowControlFeature)(0), // 1: FlowControlFeature
	(*Packet)(nil),          // 2: Packet
	...
	(*Drain)(nil),           // 8: Drain
	(*Data)(nil),            // 9: Data
	(*WindowUpdate)(nil),    // 10: WindowUpdate
}
var file_konnectivity_client_proto_client_client_proto_depIdxs = []int32{
	...
	9,  // 3: Packet.data:type_name -> Data
	...
	8,  // 7: Packet.drain:type_name -> Drain
	10, // 8: Packet.window_update:type_name -> WindowUpdate
	1,  // 9: DialRequest.offered_flow_control_features:type_name -> FlowControlFeature
	1,  // 10: DialResponse.accepted_flow_control_features:type_name -> FlowControlFeature
	2,  // 11: ProxyService.Proxy:input_type -> Packet
	2,  // 12: ProxyService.Proxy:output_type -> Packet
